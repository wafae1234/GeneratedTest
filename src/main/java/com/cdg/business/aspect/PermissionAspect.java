...
import static com.cdg.business.service.audit.Operation.INSERTE_PERMISSION;
import static com.cdg.business.service.audit.Operation.UPDATE_PERMISSION;
...
import com.cdg.business.service.PermissionServiceImpl;
...
public class PermissionAspect {
	...
	@Pointcut(value = "execution(* com.cdg.business.service.PermissionServiceImpl.save(..))")
    public void mySavePointcut(){ }
	
	@Pointcut(value = "execution(* com.cdg.business.service.PermissionServiceImpl.update(..)) && args(id,permission,..)")
