...
import static com.cdg.business.service.audit.Operation.INSERTE_USER;
import static com.cdg.business.service.audit.Operation.UPDATE_USER;
...
import com.cdg.business.service.UserServiceImpl;
...
public class UserAspect {
	...
	@Pointcut(value = "execution(* com.cdg.business.service.UserServiceImpl.save(..))")
    public void mySavePointcut(){ }
	
	@Pointcut(value = "execution(* com.cdg.business.service.UserServiceImpl.update(..)) && args(id,appUser,..)")
